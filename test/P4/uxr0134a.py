...
class Uxr0134a(object):
    ...
    def set_clock_recovery_ojtf(self, method="FOPLL", data_rate=4e9, loop_bandwidth=2.4e6, damping_fact=0.707):
...
if __name__ == "__main__":
    uxr = Uxr0134a("TCPIP0::169.254.202.222::inst0::INSTR", "TCPIP")
    chip_num = 'SS10'
    temp_volt = "NTHV"
    datarate = "16Gbps"
    pattern = "clk"
    ...
    code_mode = "CT"  # 粗调
    i=0
    uxr.save_screen_image(f"C:\\FK\\{chip_num}_{temp_volt}_{datarate}_{i}_{cfg_mode}_{code_mode}.png")
