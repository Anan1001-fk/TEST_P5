...
def test():
   ...
   e8257d=E8257D.E8257D()
   e8257d.__init__(addr="TCPIP0::169.254.184.140::inst0::INSTR")
   e8257d.set_frequency(16)
   e8257d.set_amplitude(50,"mv")
   for i in range(len(temp_list)):
       ws.cell(row=last_row, column=i + 1, value=temp_list[i])
   wb.save("P5_JTOL.xlsx")
   save_test_data_to_txt("P5_JTOL", temp_list)
   last_row = last_row + 1
